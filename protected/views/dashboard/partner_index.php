            ...
            <div class="box-body no-padding">
              <ul class="users-list clearfix">
              	...
              	foreach($Reviewusers as $partner){
                    ...
                    $logo = Yii::app()->basePath.'/../uploads/partner/'.$partnerData->id.'/logo/'.$partnerData->logo;
                    if(file_exists($logo)){
                      $image = Yii::app()->request->baseUrl.'/uploads/partner/'.$partnerData->id.'/logo/'.$partnerData->logo;
                    }else{
                      $image = Yii::app()->request->baseUrl."/vendor/images/default.png";
                    }
              	    ?>
                    <li>
                      <img src="<?php echo $image;?>" alt="Partner Logo">
                      <a class="users-list-name" href="<?php echo $image;?>"><?php echo $partnerData->name;?></a>
...
?>
<script src="<?php echo Yii::app()->request->baseUrl; ?>/vendor/js/Chart.js"></script> 
