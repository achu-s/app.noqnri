...
<div class="box">
    <div class="box-body">
<h1>Manage Privillage Updates</h1>
<hr>
<?php
...
<div class="page-size-wrap" style="width:100%">
    <div class="results-perpage">
        ...
        <?php if(Yii::app()->user->id==1){?>
        	<a href="<?php echo Yii::app()->request->baseUrl."/privillageUpdates/create/"?>" style="float:right;padding: 3px 8px;margin-left:10px;" class="btn btn-primary">Add New</a>
        <?php }?>
    </div>
</div>
        ...
        array(
            ...
            'buttons' => array(
                    'update' => array(
                        ...
                        'url' => function($data) {
                            $url = Yii::app()->createUrl('privillageUpdates/update/' . $data->id);
                            return $url;
                        },
                    ),
                    'view' => array( //the name {reply} must be same
                        ...
                        'url' => function($data) {
                            $url = Yii::app()->createUrl('privillageUpdates/view?id=' . $data->id);
                            return $url;
                         },
                     ),
                  )
