<p class="login-box-msg">Send OTP</p>
        ...
        <div  class="form-group has-feedback">
            <?php echo $form->textField($card, 'card_number', array('id'=>'otp_card_number','class'=>'form-control','placeholder' => '10 Digit Card Number','autocomplete'=>"off",'maxlength'=>"10",'readonly'=>true,'data-validation'=>"required")); ?>
            <span class="glyphicon glyphicon-user form-control-feedback"></span>
            <span class="validate_class"></span>
        </div>
        <div  class="form-group has-feedback" id="phone_number">
            <?php echo $form->textField($card, 'phone_number', array('id'=>'otp_phone_number','class'=>'form-control','placeholder' => 'Phone Number','autocomplete'=>"off",'readonly'=>true,'data-validation'=>"required")); ?>
