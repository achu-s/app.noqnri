<p class="login-box-msg">Validate OTP</p>
        ...
        <div  class="form-group has-feedback">
            <?php echo $form->textField($card, 'card_number', array('id'=>'validate_card_number','class'=>'form-control','placeholder' => '10 Digit Card Number','autocomplete'=>"off",'maxlength'=>"10",'readonly'=>true,'data-validation'=>"required")); ?>
            <span class="glyphicon glyphicon-user form-control-feedback"></span>
        </div>
        <div  class="form-group has-feedback" id="phone_number">
            <?php echo $form->textField($card, 'phone_number', array('id'=>'validate_conform_Phone','class'=>'form-control','placeholder' => 'Phone Number','autocomplete'=>"off",'readonly'=>true,'data-validation'=>"required")); ?>
            <span class="glyphicon glyphicon-phone form-control-feedback"></span>
        </div>
        <div  class="form-group has-feedback" id="otp_confirm" style="margin-bottom: 0px;">
                <?php echo $form->passwordField($card, 'otp', array('class'=>'form-control','placeholder' => 'OTP','autocomplete'=>"off",'data-validation'=>"required")); ?>
                <span class="glyphicon glyphicon-user form-control-feedback"></span>
