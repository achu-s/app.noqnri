...
class ForkindUser extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('first_name, last_name, login_id, status, created_on', 'required'),
			array('login_id, parent_id', 'numerical', 'integerOnly'=>true),
			...
			array('id, first_name, middle_name, last_name, phone_number, email_id, login_id, parent_id, status, created_on, updated_on', 'safe', 'on'=>'search'),
		);
	}
	...
	public function Status($data){
	    ...
	    if($loginData){
    	    ...
    	    echo "<input type='checkbox' class='switch' ".$status." ref='$data->id' res='Sales'>";
	    }
	}
