...
class Enquiry extends CActiveRecord
{
	...
	public function ActionButton($data){
	    if($data->status == "N"){
	       echo '<a class="btn btn-primary btn-xss" title="Update" style="margin-right:0px" data-toggle="modal" data-target="#myModal" onclick="ApproveEnquiry(this)" id='.$data->id.'><i class="icon-pencil icon-white"></i> Approve</a>';
	    }else{
	        echo '<a class="btn btn-success btn-xxs" title="Update" style="margin-right:0px"><i class="icon-pencil icon-white"></i> Closed</a>';
	    }
	}
}
